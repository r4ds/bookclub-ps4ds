...
You can install all packages used by these notes and recommended by the book authors*:
...
* Chapter 5 uses {DMwR}, which is currently unavailable on CRAN. We'll confirm when we get there, but I'm guessing {DMwR2} will work instead.
